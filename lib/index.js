...
function writeReadme(list) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield (0, promises_1.writeFile)("README.md", content);
    const data = yield (0, promises_1.readFile)("README.md", "utf-8");
...
function writeIndex(list) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const data = yield (0, promises_1.readFile)("./docs/index.md", "utf-8");
    console.log("异步读取文件数据: " + data);
  });
}
